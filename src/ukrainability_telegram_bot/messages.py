"""Bilingual (EN/UK) message strings used across the survey flow."""

PRIVACY_NOTICE_URL_EN = "https://telegra.ph/Ukrainabilitys-Privacy-Notice-03-15"

PARTICIPANT_INFORMATION_SHEET_URL_EN = (
    "https://telegra.ph/Participant-Information-Sheet-for-Ukrainability-project-03-15"
)

PRIVACY_NOTICE_URL_UK = (
    "https://telegra.ph/Polіtika-konfіdencіjnostі-dlya-doslіdzhennya-Ukrainability-03-14"
)

PARTICIPANT_INFORMATION_SHEET_URL_UK = (
    "https://telegra.ph/Іnformacіjnij-list-dlya-uchasnikіv-proektu-Ukrainability-03-14"
)
...
By clicking 'I agree', I confirm that I am 18+ years old, have received sufficient information about the study, and consent to participate. My data will be processed according to GDPR and Ukrainian personal data protection law.""",
        ...
        # Kept English-only because this fallback is used before language is known.
        ...
        "options": {
            ...
            "age": ["18-25", "26-40", "41-60", "Above 60", "Prefer not to disclose"],
...
Натискаючи «Я погоджуюсь», я підтверджую, що мені більше 18 років, я отримав(ла) достатньо інформації про дослідження та погоджуюсь взяти участь. Дані будуть оброблятись відповідно до європейського та українського законодавства про захист персональних даних.""",
        ...
        "options": {
            ...
            "age": ["18-25", "26-40", "41-60", "Понад 60", "Надаю перевагу не вказувати"],
            "gender": ["Чоловіча", "Жіноча", "Інше", "Надаю перевагу не вказувати"],
            "occupation": [
                "Працюю",
                "Не працюю",
                "Навчаюсь",
